...
extension AppColor on Color {
  static Color get primaryBlue => const Color(0xFF0087C8);
  ...
  static Color get uaRed => const Color(0xFFE3004A);

  static Color get lightUaRed => const Color(0xFFFFDDE8);

  static Color get spanishGrey => const Color(0xFF92989C);
